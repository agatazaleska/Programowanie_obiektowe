...
//Klasa odpowiadająca za instrukcje razy
//Jako argumenty podajemy wyrażenia arytmetyczne
public class Razy extends Wyrażenie2ArgArytmetyczne {
    @JsonCreator
    public Razy(@JsonProperty("argument1") WyrażenieArytmetyczne arg1,
